...
use ron_core::{parse, DiagnosticCode, Severity};
...
fn validate(model: &Value, type_name: &str, src: &str) -> Vec<ron_core::Diagnostic> {
...
fn expect_one(
    ...
    assert_eq!(d.code().source(), "ron-types");
}
