...
use ron_types::model::{NodeKind, Primitive, VariantShape};
use ron_types::source::{BevyRegistry, ReflectKind};
...
fn precedence_and_source_id() {
    ...
    assert_eq!(
        src.precedence(),
        ron_types::source::SourcePrecedence::Bevy,
    ...
    assert!(
        acq.diagnostics
            ...
            .any(|d| d.subject == "some_mod::experimental::FancyThing"
                && d.category == ron_types::diagnostics::DiagnosticCategory::UnsupportedConstruct),
